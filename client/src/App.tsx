...
export default function App() {
  ...
  const url = "http://localhost:3050/translate";
  ...
  return (
    <>
      {/* Header Minimalis dengan Judul di Kiri */}
      <header className="bg-white border-b border-gray-200 py-4 px-6 fixed top-0 left-0 right-0 z-10">
        <div className="max-w-4xl mx-auto flex justify-between items-center">
          <div className="flex items-center">
            <h1 className="text-xl font-bold text-gray-800">AkbarDev</h1>
          </div>
